...
//        3.	사용자가 원하는 연산을 선택하게 하고 선택한 값을 choice에 저장한다.
            System.out.println("1.추가 2.삭제 3.찾기 4.추력 5.종료");
            System.out.print("메뉴선택 >> ");
            choice = Integer.parseInt(scanner.nextLine());
            switch (choice){
//        4.	choice가 1이면 추가하는 학생의 학번과 이름을 입력 받아 학생 객체를 생성한 후 그 객체를 출석부에 추가하고 출력한다.
                case 1 :
                    System.out.print("학생의 학번" ); number = scanner.nextLine();
                    System.out.print("학생의 이름" ); name = scanner.nextLine();
